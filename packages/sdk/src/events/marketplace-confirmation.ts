...
export function create_marketplace_confirmation_event(
  ...
  const content_object: Record<string, unknown> = {
    ...
    ref_attention_confirmation_event_id: params.attention_confirmation_event_id,
  ...
  // Required e tag references with markers
  tags.push(["e", params.match_event_id, "", "match"]);
  tags.push([
    "e",
    params.billboard_confirmation_event_id,
    "",
    "billboard_confirmation",
  ]);
  tags.push([
    "e",
    params.attention_confirmation_event_id,
    "",
