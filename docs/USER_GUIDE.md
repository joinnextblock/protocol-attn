...
> For detailed technical specifications, see [ATTN-01](#attn-01---attn-protocol---core).
...
> For detailed event specifications and protocol requirements, see [ATTN-01](#attn-01---attn-protocol---core).
...
> For detailed event schemas and required tags, see [ATTN-01](#attn-01---attn-protocol---core).
...
> For detailed BILLBOARD requirements and protocol behavior, see [ATTN-01](#attn-01---attn-protocol---core).
...
1. **Start Here**: [ATTN Protocol overview](#attn-protocol) provides protocol overview, event kinds, and links to all documentation
2. **Protocol Spec**: [ATTN-01](#attn-01---attn-protocol---core) contains complete event schemas with standardized format (Purpose, Published By, When, Content Schema table, Tag Schema table, Relationships, Example)
3. **Implementation**:
...
4. **User Guide**: This section provides user-facing documentation, glossary, and quick reference
...
- **"What tags are required?"** -> See [Quick Reference - Required Tags](#required-tags-per-event-type) or [ATTN-01](#attn-01---attn-protocol---core) for each event type
...
1. Check [ATTN-01](#attn-01---attn-protocol---core) for the canonical specification
...
- [ATTN-01](#attn-01---attn-protocol---core): ATTN Protocol - Core protocol specifications and event definitions

> For a complete technical overview of the protocol, including event schemas, tag specifications, content field definitions, and behavior, refer to [ATTN-01](#attn-01---attn-protocol---core).
