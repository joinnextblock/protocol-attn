...
### NEW EVENT KINDS
- **kind:38688**: BILLBOARD METRICS - PROMOTER-facing anonymous metrics event
...
- **kind:38688**: Provides PROMOTER-facing anonymized metrics
...
Event kind:38688 providing anonymized metrics for PROMOTERS
