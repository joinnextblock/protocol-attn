...
3. **BILLBOARD Operators**: Infrastructure providers that connect PROMOTION Creators with PROMOTION Viewers
   ...
   - Publish kind:31990 match events and confirmation events
...
3. **Matching Process**: BILLBOARDs monitor both event kinds and create matches when:
   ...
   - The match is recorded in a kind:31990 event
...
6. **Confirmation**: A kind:31990 confirmation event is published, creating a permanent record of the successful view.
...
The PROMO Protocol includes an explicit matching process where BILLBOARDs create standardized match events (kind:31990) to transparently record when a PROMOTION CREATOR's promotion is matched with a PROMOTION VIEWER:

- **Match Events**: BILLBOARDs publish kind:31990 events that create a transparent record of matching decisions
...
Match events (kind:31990) contain key information about the promotion arrangement:
...
- **View Confirmation**: The BILLBOARD publishes a kind:31990 confirmation event after successful viewing
...
5. **Confirmation Publication**: kind:31990 event published
...
1. **BILLBOARD Support**:
   ...
   - Verify relay URLs listed in BILLBOARD kind:31990 events
   - Prioritize relays with consistent uptime and performance

2. **Protocol Compatibility**:
   - Ensure relays support all required event kinds (31990, 38188, 38888)
...
1. **Primary Relays**:
   - Listed in BILLBOARD kind:31990 events
